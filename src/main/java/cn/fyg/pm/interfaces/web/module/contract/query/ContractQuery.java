...
public class ContractQuery implements QuerySpec<Contract> {
	...
	@Override
	public List<Predicate> criterias(CriteriaBuilder builder,Root<Contract> from) {
		...
		if(this.getContractType()!=null){
			criterias.add(builder.equal(from.get("type"), this.getContractType()));
		}
	...
	@Override
	public List<Order> orders(CriteriaBuilder builder, Root<Contract> from) {
